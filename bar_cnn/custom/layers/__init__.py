...
from bar_cnn.custom.layers.box_clipping import BoxClipping
from bar_cnn.custom.layers.box_regression import BoxRegression
from bar_cnn.custom.layers.filter_detections import FilterDetections